...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Successful sign-in (or sign-up) -> go home
    router.push("/");
  };
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-8 py-12">
        <div className="bg-white dark:bg-zinc-900/60 rounded-lg shadow p-8 border border-zinc-100 dark:border-zinc-800">
          <div className="flex items-center justify-between mb-6">
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">Join Gym Tracker to log workouts</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2 flex items-center gap-4 mt-2">
              ...
              <Link href="/signin" className="text-sm text-zinc-600 dark:text-zinc-300 hover:underline">
